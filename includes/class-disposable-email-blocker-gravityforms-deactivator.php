<?php
/**
 * This file contains the definition of the Disposable_Email_Blocker_Gravityforms_Deactivator class, which
 ...
 * @since    2.0.0
 */
class Disposable_Email_Blocker_Gravityforms_Deactivator {
	/**
	 * Deactivation hook.
	 *
